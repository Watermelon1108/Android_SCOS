 ...
 */
public class LengcaiAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    List<Map<String, Object>> mData;
    public LengcaiAdapter(Context context, List<Map<String, Object>> Data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.liangcai_item, null);
